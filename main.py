        ...
        with tf.Session() as sess:
            ...
            while(True):
                ...
                def urljatayu():
                    ...
                    pintu = urllib.request.urlopen(urllib.request.Request('http://jatayu.io/api/data/646ce982-de9b-11e9-8801-e4066d151e57/v1?value=1')) 
                    ket = urllib.request.urlopen(urllib.request.Request('http://jatayu.io/api/data/646ce982-de9b-11e9-8801-e4066d151e57/v2?value=CAM')) 
                    saha = urllib.request.urlopen(urllib.request.Request('http://jatayu.io/api/data/646ce982-de9b-11e9-8801-e4066d151e57/v3?value=%s' %aran))
                    print("Membuka pintu")
                ...
                if len(face_patches) > 0:
                    ...
                    for bb, landmark, matching_id, dist in zip(padded_bounding_boxes, landmarks, matching_ids, matching_distances):
                        if matching_id is None:
                            ...
                            cv2.putText(frame, "Akses Ditolak ", (50,50), cv2.FONT_HERSHEY_SIMPLEX , 1, (0, 0, 255), 2, cv2.LINE_AA)
                            
                        else:
                            print('Sampurasun %s! Jarak: %1.4f' % (matching_id, dist))
                            global dikenal
                            dikenal = True

                            cv2.putText(frame, "Akses Diterima ", (50,50), cv2.FONT_HERSHEY_SIMPLEX , 1, (0, 255, 0), 2, cv2.LINE_AA)
                        ...
                        if show_id:
                            ...
                            cv2.putText(frame, matching_id, (bb[0], bb[3]), font, 1, (158, 126, 0), 2, cv2.LINE_AA)
                        if show_bb:
